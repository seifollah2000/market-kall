...
export default function Footer() {
    return (
        <footer className='m-5 p-3 footer'>
            ...
            <div className="fastAccess py-3">
                <div className="fastAccess__rigth col-6">
                ...
                <div className="fastAccess__left col-4">
                    <h6 className='fastAccess__left-title'>با عضویت در خبرنامه از آخرین اخبار و محصولات سایت مطلع شوید...</h6>
                    <div className="fastAccess__left-body">
            ...
            <div className='information d-flex'>
                <div className="information__text col-9">
                ...
                <div className='information__berand col-2'>
                    <Swiper
                        spaceBetween={30}
                        centeredSlides={true}
                        autoplay={{
